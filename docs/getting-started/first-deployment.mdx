  ...
  <div className="flex">
    <div className="ml-3">
      <p className="text-sm text-blue-700">
        <strong>Prerequisites:</strong> Complete both <a href="/docs/getting-started/installation" className="underline font-medium">Installation</a> and <a href="/docs/getting-started/start" className="underline font-medium">Environment Setup</a> before proceeding. This guide assumes your dstack infrastructure is running and configured.
      </p>
    </div>
  </div>
</div>

This final guide in the self-hosted dstack deployment series walks you through deploying your first application to your newly configured Trusted Execution Environment. You'll deploy a containerized application, verify it's running securely within your infrastructure, and confirm the end-to-end security guarantees.

<div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6">
  <div className="flex">
    <div className="ml-3">
      <p className="text-sm text-green-700">
        <strong>🎉 Final Step:</strong> Deploy and verify your first secure application on your self-hosted dstack infrastructure.
      </p>
      <p className="text-sm text-green-700 mt-2">
        <strong>Time Required:</strong> About 15-30 minutes after your dstack services are running.
      </p>
    </div>
  </div>
</div>
...
- ✅ dstack installed via the [Installation Guide](/docs/getting-started/installation)
- ✅ Environment configured via the [Environment Setup Guide](/docs/getting-started/start)  
- ✅ All dstack services running (KMS, Gateway, VMM)
- ✅ TEE-capable hardware (Intel TDX) verified and operational
- ✅ Network access to your dstack management interface (http://localhost:9080)

<details>
<summary>Quick Service Verification</summary>

Verify your dstack services are operational:
