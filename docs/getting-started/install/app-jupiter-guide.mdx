---
title: "Application Quick Start Guide"
description: "this is how you and a remote host can quickly deploy apps on dstack"
---
# Quick Start: Jupyter Notebook on dstack

Follow these steps to securely run Jupyter Notebook on dstack.
