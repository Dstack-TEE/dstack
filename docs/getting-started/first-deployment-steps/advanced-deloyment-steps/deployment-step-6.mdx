...
<div className="bg-white border border-gray-200 rounded-lg p-6 my-6">
  ...
  <div className="flex flex-col md:flex-row gap-4">
    <div className="flex-1">
      <h4 className="font-medium mb-2">Follow Initial Steps</h4>
      <p className="text-sm text-gray-600">Follow the steps at the beginning of this document to deploy dstack-vmm on other TDX hosts.</p>
    </div>
