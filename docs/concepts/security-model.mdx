...
<CardGroup cols={3}>
  <Card title="Deploy Securely" icon="shield" href="/deployment-guides/deploying-applications">
...
For deployment guides and security best practices, see our [deployment documentation](/deployment-guides/deploying-applications). 