...
<div className="mt-8 flex gap-4">
  <a href="/concepts/security-model" className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">
    Learn Security Model →
  </a>
  <a href="/deployment-guides/configuring-components" className="bg-gray-200 text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-300">
