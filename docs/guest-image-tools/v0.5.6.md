# dstack Guest Image Tools: v0.5.6
...
| Field | Value |
|---|---|
| Guest image version | `0.5.6` |
| meta-dstack revision | `e50408efb0fabc2ada79c6c445f8866a8a4e61b8` |
| Image flavor | `prod` |
...
`bridge`, `conntrack`, `ethtool`, `ipset`, `nft`, `parted`, `python3`, `rsync`, `ss`, `ssh`, `sshd`,
`tc`, `tcpdump`
