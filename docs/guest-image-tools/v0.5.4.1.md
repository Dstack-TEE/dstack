# dstack Guest Image Tools: v0.5.4.1
...
| Field | Value |
|---|---|
| Guest image version | `0.5.4.1` |
| meta-dstack revision | `4b38f2c01e8ce72824cadbb049d45c5628b05b0d` |
| Image flavor | `prod` |
...
`bridge`, `conntrack`, `ethtool`, `ipset`, `nft`, `parted`, `python3`, `rsync`, `sgdisk`, `ss`,
`ssh`, `sshd`, `tc`, `tcpdump`
...
`fgrep`, `find`, `free`, `fuser`, `grep`, `head`, `hostname`, `id`, `ifconfig`, `ifdown`, `ifup`,
...
`who`, `whoami`, `xargs`, `xzcat`, `yes`

### Bash 5.2.21

`bash`, `bash.bash`, `sh`

### dstack guest components 0.5.4.1
