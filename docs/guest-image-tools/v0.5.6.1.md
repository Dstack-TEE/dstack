# dstack Guest Image Tools: v0.5.6.1
...
| Field | Value |
|---|---|
| Guest image version | `0.5.6.1` |
| meta-dstack revision | `f1c68d35bd99c56193d88f4abbe3a923aa48a6b7` |
| Image flavor | `prod` |
...
`bridge`, `conntrack`, `ethtool`, `ipset`, `nft`, `parted`, `python3`, `ss`, `ssh`, `sshd`, `tc`,
`tcpdump`
...
### dstack guest components 0.5.6.1
