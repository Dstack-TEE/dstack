...
| Installation             | Guide on installing dstack components                                   | DevOps, Developers    | /getting-started/installation| Add hardware requirements, screenshots |
| First Deployment         | Step-by-step guide to deploy first application                          | Developers            | /getting-started/first-deployment | Include video tutorials    |
...
**See Also:** [Installation Guide](/getting-started/installation), [First Deployment](/getting-started/first-deployment)
...
**See Also:** [First Deployment](/getting-started/first-deployment)
