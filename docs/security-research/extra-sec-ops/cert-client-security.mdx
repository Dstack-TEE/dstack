...
<page_summary>
The cert-client component implements client-side certificate request and signing operations with hardware-backed attestation for dstack. It validates TDX quotes, enforces TCB security policies, and ensures all certificates are cryptographically bound to Trusted Execution Environment measurements.
</page_summary>
