...
DStack is a developer-friendly SDK that streamlines the deployment of containerized applications into Intel TDX Trusted Execution Environments. Built by Kevin Wang and contributors from Phala Network, inspired by Andrew Miller from Flashbots, with contributions from Nethermind and the broader community.
