---
title: "DStack High Level Technical Architecture "
description: "High Level exploration of dstack’s system architecture, components, and robust security framework leveraging Intel TDX for confidential container deployment."
---
...
If you want a deep dive into the technical architecture of dstack, check out the [architecture overview](/docs/concepts/architecture).
