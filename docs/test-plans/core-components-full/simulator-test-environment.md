...
```console
export DSTACK_TEST_LAB_MANIFEST="$PWD/docs/test-plans/core-components-full/automation/tdxlab-manifest.json"
export TMPDIR="$HOME/.cache/dstack-test/tmp"
docs/test-plans/core-components-full/automation/prepare-run.sh \
