...
Generate boot, application, RPC, Docker, and failure logs through size/time rotation and restart.

**Expected results:**

- Required logs remain queryable within retention, rotation bounds disk use, unprivileged apps cannot read host-only logs, and secrets are absent.
