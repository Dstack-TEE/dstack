...
- Prepared helper: `automation/local-provider-sealing-case.py` consumes the lease-owned primary/peer TDX guests and the configured local-key-provider endpoint; it never persists quotes, private keys, decrypted keys, or ciphertext.
