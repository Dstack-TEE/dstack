...
- Automation: Yes
- Requirements: [req-gos-platform-002](../../../feature-audit.md#req-gos-platform-002)
- Risks: [risk-gos-platform-002](../../../feature-audit.md#risk-gos-platform-002)
...
Request sealing material for valid quotes from two app/device identities and altered/replayed quotes.

**Expected results:**

- Each encrypted key is bound to verified identity/evidence, stable under its documented scope, unusable by the other identity, and replay/tampering returns no key.
