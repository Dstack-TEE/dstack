...
- Automation: Yes
- Requirements: [req-gos-guestapi-005](../../../feature-audit.md#req-gos-guestapi-005)
- Risks: [risk-gos-guestapi-005](../../../feature-audit.md#risk-gos-guestapi-005)
...
- Prepared RPC contract: `GuestApi.Shutdown` takes `google.protobuf.Empty` (no fields) and returns `google.protobuf.Empty` (no fields). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
