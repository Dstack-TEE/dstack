...
- Automation: Yes
- Requirements: [req-gw-admin-001](../../../feature-audit.md#req-gw-admin-001)
- Risks: [risk-gw-admin-001](../../../feature-audit.md#risk-gw-admin-001)
...
- Prepared RPC contract: `Admin.Status` takes `google.protobuf.Empty` (no fields) and returns `StatusResponse` (`id: uint32`, `url: string`, `bootnode_url: string`, `num_connections: uint64`, `hosts: HostInfo`, `nodes: GatewayNodeInfo`, `uuid: bytes`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
