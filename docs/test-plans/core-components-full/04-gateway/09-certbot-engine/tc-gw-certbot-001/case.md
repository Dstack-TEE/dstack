...
Create/load account against staging, restart, use wrong/corrupt credentials/directory, concurrent creation and account-server errors.

**Expected results:**

- One account identity persists with restrictive files, concurrent start does not fork accounts, and corrupt/wrong state fails without overwrite.
