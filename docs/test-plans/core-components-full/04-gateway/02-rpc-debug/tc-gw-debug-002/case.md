...
- Automation: Yes
- Requirements: [req-gw-debug-002](../../../feature-audit.md#req-gw-debug-002)
- Risks: [risk-gw-debug-002](../../../feature-audit.md#risk-gw-debug-002)
...
- Prepared RPC contract: `Debug.Info` takes `google.protobuf.Empty` (no fields) and returns `InfoResponse` (`base_domain: string`, `external_port: uint32`, `app_address_ns_prefix: string`, `version: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
