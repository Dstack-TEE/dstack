...
"""Record whether the complete gateway-internal-006 controller is available."""
...
CASE_ID = "tc-gw-internal-006"
CAPABILITY = "gateway-internal-006"
ACTION = "Port-policy filtering fetch retry and PP decision"
FIXTURE_KEY = "gateway_internal_006"
REQUIRED = [
    "gateway_argv",
    "guest_rows",
    "policy_rows",
