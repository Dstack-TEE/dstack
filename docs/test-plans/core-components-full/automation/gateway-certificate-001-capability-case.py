...
"""Record whether the complete gateway-certificate-001 controller is available."""
...
CASE_ID = "tc-gw-certificat-001"
CAPABILITY = "gateway-certificate-001"
ACTION = "ACME account bootstrap and persistence"
FIXTURE_KEY = "gateway_certificate_001"
REQUIRED = [
    "gateway_rows",
    "acme_directory_argv",
    "account_init_argv",
    "restart_argv",
    "invalid_directory_argv",
    "invalid_account_argv",
    "invalid_key_argv",
    "persistence_observer_argv",
