...
"""Record whether the complete gateway-registration-004 controller is available."""
...
CASE_ID = "tc-gw-registrati-004"
CAPABILITY = "gateway-registration-004"
ACTION = "Port policy fetch fallback compatibility"
FIXTURE_KEY = "gateway_registration_004"
REQUIRED = [
    "gateway_argv",
    "guest_rows",
    "reported_policy_argv",
    "empty_policy_argv",
    "unavailable_policy_argv",
    "malformed_policy_argv",
    "info_fallback_argv",
