...
CASE_ID = "tc-vmm-internal-003"
CAPABILITY = "vmm-image-parser-firmware-matrix"
FIXTURE_KEY = "vmm_image_parser"
REQUIRED = [
    "image_rows",
    "parse_argv",
    "completeness_observer_argv",
    "trust_observer_argv",
    "semantic_version_rows",
    "platform_rows",
    "firmware_observer_argv",
    "path_escape_rows",
    "failure_inject_argv",
    "cleanup_argv",
]
