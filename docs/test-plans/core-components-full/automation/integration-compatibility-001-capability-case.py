...
"""Record whether the complete integration-compatibility-001 controller is available."""
...
CASE_ID = "tc-int-compatibil-001"
CAPABILITY = "integration-compatibility-001"
ACTION = "Persisted state migration from v0.5.4, v0.5.8, and v0.5.11"
FIXTURE_KEY = "integration_compatibility_001"
REQUIRED = [
    "release_rows",
    "state_fixture_rows",
    "component_rows",
