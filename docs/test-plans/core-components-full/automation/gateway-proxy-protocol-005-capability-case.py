...
"""Record whether the complete gateway-proxy-protocol-005 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-005"
ACTION = "App-address namespace and content-addressed HTTPS"
FIXTURE_KEY = "gateway_proxy_protocol_005"
REQUIRED = [
    "gateway_argv",
    "backend_rows",
    "app_address_rows",
    "instance_address_rows",
    "content_address_rows",
    "altered_identifier_rows",
    "certificate_rows",
    "routing_observer_argv",
    "isolation_observer_argv",
    "cleanup_argv",
]
