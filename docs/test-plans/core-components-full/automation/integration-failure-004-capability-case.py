...
"""Record whether the complete integration-failure-004 controller is available."""
...
CAPABILITY = "integration-failure-004"
ACTION = "Certificate and clock boundary behavior"
FIXTURE_KEY = "integration_failure_004"
REQUIRED = [
    "kms_rows",
    "gateway_rows",
    "guest_rows",
