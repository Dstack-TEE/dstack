...
"""Record whether the complete integration-compatibility-004 controller is available."""
...
CASE_ID = "tc-int-compatibil-004"
CAPABILITY = "integration-compatibility-004"
ACTION = "Rolling gateway cluster upgrade"
FIXTURE_KEY = "integration_compatibility_004"
REQUIRED = [
    "gateway_release_rows",
    "gateway_cluster_rows",
    "guest_rows",
    "certificate_rows",
    "rolling_upgrade_argv",
    "traffic_argv",
