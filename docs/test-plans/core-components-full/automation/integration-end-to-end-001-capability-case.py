...
"""Record whether the complete integration-end-to-end-001 controller is available."""
...
CASE_ID = "tc-int-end-to-end-001"
CAPABILITY = "integration-end-to-end-001"
ACTION = "New application deployment trust chain"
FIXTURE_KEY = "integration_end_to_end_001"
REQUIRED = [
    "vmm_rows",
    "kms_rows",
    "gateway_rows",
