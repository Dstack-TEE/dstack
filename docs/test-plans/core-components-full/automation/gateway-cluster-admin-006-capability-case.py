...
"""Record whether the complete gateway-cluster-admin-006 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-006"
ACTION = "Debug service isolation"
FIXTURE_KEY = "gateway_cluster_admin_006"
REQUIRED = [
    "gateway_argv",
