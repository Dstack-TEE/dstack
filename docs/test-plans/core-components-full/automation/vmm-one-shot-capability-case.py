...
CASE_ID = "tc-vmm-internal-006"
CAPABILITY = "vmm-one-shot-lifecycle"
FIXTURE_KEY = "vmm_one_shot"
REQUIRED = [
    "success_workload_argv",
    "failure_workload_argv",
    "tool_failure_argv",
    "exit_status_observer_argv",
    "temporary_vm_observer_argv",
    "resource_observer_argv",
    "daemon_vm_sentinel_argv",
    "concurrency_argv",
    "retry_argv",
    "cleanup_argv",
]
