...
"""Record whether the complete gateway-certificate-004 controller is available."""
...
CAPABILITY = "gateway-certificate-004"
ACTION = "ZT domain CRUD and certificate lifecycle"
FIXTURE_KEY = "gateway_certificate_004"
REQUIRED = [
    "gateway_argv",
    "provider_argv",
    "credential_argv",
