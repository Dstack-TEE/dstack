...
"""Record whether the complete gateway-proxy-protocol-002 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-002"
ACTION = "Outbound Proxy Protocol per-port opt-in"
FIXTURE_KEY = "gateway_proxy_protocol_002"
REQUIRED = [
    "gateway_argv",
    "backend_argv",
    "port_rows",
    "tls_termination_argv",
    "tls_passthrough_argv",
    "pp_capture_argv",
    "non_pp_capture_argv",
    "byte_parity_observer_argv",
    "header_count_observer_argv",
    "cleanup_argv",
]
