...
"""Record whether the complete gateway-internal-008 controller is available."""
...
CAPABILITY = "gateway-internal-008"
ACTION = "Combined route index RPC exposure"
FIXTURE_KEY = "gateway_internal_008"
REQUIRED = [
    "gateway_argv",
