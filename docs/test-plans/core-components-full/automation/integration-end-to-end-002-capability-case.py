...
"""Record whether the complete integration-end-to-end-002 controller is available."""
...
CASE_ID = "tc-int-end-to-end-002"
CAPABILITY = "integration-end-to-end-002"
ACTION = "Application upgrade trust continuity"
FIXTURE_KEY = "integration_end_to_end_002"
REQUIRED = [
    "vmm_rows",
    "kms_rows",
    "gateway_rows",
