...
ROWS = (
    (
        ...
        [
            ...
            "-p",
            "dstack-verifier",
            "five_platform_tcb_policy_decision_table_is_exhaustive",
            "--lib",
        ],
        "simulation",
    ),
    ...
    (
        ...
        [
            ...
            "-p",
            "dstack-attest",
            "tdx_v2_event_log_rtmr3_failure_and_recovery_matrix",
            "--lib",
        ],
        "simulation",
    ),
...
def main() -> int:
    ...
    evidence = {
        ...
        "rows": rows,
        "policy_rows_inside_decision_table": 7,
        "platforms": ["tdx", "gcp-tdx", "sev-snp", "nitro-tpm", "nitro-enclave"],
        "covered_behaviors": [
            "up_to_date_out_of_date_and_revoked",
            ...
            "cross_identity_event_replay_rejection",
