...
"""Record whether the complete integration-failure-006 controller is available."""
...
CAPABILITY = "integration-failure-006"
ACTION = "Resource exhaustion and backpressure"
FIXTURE_KEY = "integration_failure_006"
REQUIRED = [
    "component_rows",
    "resource_limit_rows",
    "load_rows",
