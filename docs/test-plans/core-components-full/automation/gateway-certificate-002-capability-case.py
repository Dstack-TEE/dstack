...
"""Record whether the complete gateway-certificate-002 controller is available."""
...
CASE_ID = "tc-gw-certificat-002"
CAPABILITY = "gateway-certificate-002"
ACTION = "Distributed certificate issue renew and lock"
FIXTURE_KEY = "gateway_certificate_002"
REQUIRED = [
    "gateway_rows",
    "acme_argv",
    "dns_provider_argv",
