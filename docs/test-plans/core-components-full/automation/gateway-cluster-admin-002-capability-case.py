...
"""Record whether the complete gateway-cluster-admin-002 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-002"
ACTION = "WaveKV sync endpoint authentication and replay"
FIXTURE_KEY = "gateway_cluster_admin_002"
REQUIRED = [
    "gateway_rows",
    "sync_listener_argv",
    "credential_rows",
