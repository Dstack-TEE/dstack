...
"""Record whether the complete integration-end-to-end-005 controller is available."""
...
CASE_ID = "tc-int-end-to-end-005"
CAPABILITY = "integration-end-to-end-005"
ACTION = "Multi-instance load balancing and isolation"
FIXTURE_KEY = "integration_end_to_end_005"
REQUIRED = [
    "vmm_rows",
    "kms_rows",
    "gateway_rows",
