...
"""Record whether the complete integration-failure-001 controller is available."""
...
CASE_ID = "tc-int-failure-se-001"
CAPABILITY = "integration-failure-001"
ACTION = "KMS unavailable during boot and recovery"
FIXTURE_KEY = "integration_failure_001"
REQUIRED = [
    "vmm_rows",
    "kms_rows",
    "guest_rows",
