...
"""Record whether the complete gateway-registration-003 controller is available."""
...
CASE_ID = "tc-gw-registrati-003"
CAPABILITY = "gateway-registration-003"
ACTION = "Restrict-mode port enforcement"
FIXTURE_KEY = "gateway_registration_003"
REQUIRED = [
    "gateway_argv",
    "guest_rows",
    "listed_port_argv",
