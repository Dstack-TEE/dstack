...
"""Record whether the complete gateway-cluster-admin-008 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-008"
ACTION = "TLS crypto provider and protocol matrix"
FIXTURE_KEY = "gateway_cluster_admin_008"
REQUIRED = [
    "gateway_rows",
    "provider_rows",
    "protocol_rows",
    "cipher_rows",
    "valid_handshake_rows",
    "invalid_handshake_rows",
    "reload_argv",
    "negotiation_observer_argv",
    "log_observer_argv",
    "cleanup_argv",
]
