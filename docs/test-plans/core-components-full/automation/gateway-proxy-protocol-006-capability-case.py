...
"""Record whether the complete gateway-proxy-protocol-006 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-006"
ACTION = "Connection limits timeouts and recycling"
FIXTURE_KEY = "gateway_proxy_protocol_006"
REQUIRED = [
    "gateway_argv",
    "backend_argv",
    "global_limit_argv",
