...
"""Record whether the complete gateway-proxy-protocol-001 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-001"
ACTION = "Inbound Proxy Protocol v1/v2 parsing"
FIXTURE_KEY = "gateway_proxy_protocol_001"
REQUIRED = [
    "gateway_argv",
    "listener_rows",
    "backend_argv",
