...
"""Record whether the complete gateway-proxy-protocol-004 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-004"
ACTION = "TLS termination routing and HTTP semantics"
FIXTURE_KEY = "gateway_proxy_protocol_004"
REQUIRED = [
    "gateway_argv",
    "backend_argv",
    "http1_argv",
