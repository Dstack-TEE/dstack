...
"""Record whether the complete integration-failure-003 controller is available."""
...
CAPABILITY = "integration-failure-003"
ACTION = "VMM crash during every lifecycle transaction"
FIXTURE_KEY = "integration_failure_003"
REQUIRED = [
    "vmm_rows",
    "guest_rows",
    "lifecycle_rows",
