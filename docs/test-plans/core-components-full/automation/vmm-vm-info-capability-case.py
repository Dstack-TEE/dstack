...
CASE_ID = "tc-vmm-internal-005"
CAPABILITY = "vmm-vm-info-projection-matrix"
FIXTURE_KEY = "vmm_vm_info"
REQUIRED = [
    "status_rows",
    "projection_argv",
    "optional_presence_observer_argv",
    "network_backend_rows",
    "app_url_rows",
    "uptime_observer_argv",
    "event_observer_argv",
    "stale_state_rows",
