...
"""Record whether the complete gateway-certificate-003 controller is available."""
...
CAPABILITY = "gateway-certificate-003"
ACTION = "DNS credential CRUD and default selection"
FIXTURE_KEY = "gateway_certificate_003"
REQUIRED = [
    "gateway_argv",
    "provider_rows",
    "create_argv",
