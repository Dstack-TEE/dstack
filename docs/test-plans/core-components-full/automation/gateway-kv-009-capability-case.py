...
"""Record whether the complete gateway-kv-009 controller is available."""
...
CAPABILITY = "gateway-kv-009"
ACTION = "WaveKV key encoding corruption persistence and watch semantics"
FIXTURE_KEY = "gateway_kv_009"
REQUIRED = [
    "wavekv_rows",
    "key_rows",
    "encoding_rows",
