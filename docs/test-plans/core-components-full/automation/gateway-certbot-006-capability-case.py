...
"""Record whether the complete gateway-certbot-006 controller is available."""
...
CAPABILITY = "gateway-certbot-006"
ACTION = "Certbot CLI once daemon config and signal lifecycle"
FIXTURE_KEY = "gateway_certbot_006"
REQUIRED = [
    "certbot_argv",
    "once_argv",
    "daemon_argv",
