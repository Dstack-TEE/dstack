...
CASE_ID = "tc-vmm-internal-008"
CAPABILITY = "vmm-launcher-qemu-swtpm-lifecycle"
FIXTURE_KEY = "vmm_launcher_coupling"
REQUIRED = [
    "launcher_rows",
    "qemu_argv",
    "swtpm_argv",
    ...
    "qemu_failure_argv",
    "swtpm_failure_argv",
    "peer_reap_observer_argv",
    "socket_observer_argv",
    "pid_group_observer_argv",
    "retry_argv",
    "cleanup_argv",
]
