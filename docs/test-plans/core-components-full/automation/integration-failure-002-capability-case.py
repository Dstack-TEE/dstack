...
"""Record whether the complete integration-failure-002 controller is available."""
...
CASE_ID = "tc-int-failure-se-002"
CAPABILITY = "integration-failure-002"
ACTION = "Gateway unavailable registration and recovery"
FIXTURE_KEY = "integration_failure_002"
REQUIRED = [
    "gateway_rows",
    "guest_rows",
    "registration_argv",
    "gateway_failure_argv",
    "retry_observer_argv",
    "gateway_recovery_argv",
    "route_observer_argv",
    "duplicate_observer_argv",
    "availability_observer_argv",
    "cleanup_argv",
]
