...
CASE_ID = "tc-vmm-manifest-002"
CAPABILITY = "vmm-manifest-qemu-vmconfig-agreement"
FIXTURE_KEY = "vmm_manifest_agreement"
REQUIRED = [
    "configuration_rows",
    "create_vm_argv",
    "persisted_manifest_observer_argv",
    "qemu_argv_observer_argv",
    "vm_config_observer_argv",
    "public_status_observer_argv",
    "presence_sensitive_rows",
    "invalid_row_argv",
    "restart_argv",
    "reload_argv",
    "recovery_argv",
