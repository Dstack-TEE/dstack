...
"""Record whether the complete gateway-cluster-admin-005 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-005"
ACTION = "Admin authentication and listener isolation"
FIXTURE_KEY = "gateway_cluster_admin_005"
REQUIRED = [
    "gateway_argv",
    "public_listener_argv",
    "admin_listener_argv",
    "credential_rows",
    "authorized_argv",
    "unauthorized_rows",
