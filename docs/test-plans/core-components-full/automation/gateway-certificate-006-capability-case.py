...
"""Record whether the complete gateway-certificate-006 controller is available."""
...
CAPABILITY = "gateway-certificate-006"
ACTION = "Certificate store SNI wildcard and hot reload"
FIXTURE_KEY = "gateway_certificate_006"
REQUIRED = [
    "gateway_rows",
    "certificate_rows",
    "exact_sni_argv",
    ...
    "unknown_sni_argv",
    "reload_argv",
    "concurrent_connection_argv",
    "certificate_observer_argv",
    "reload_observer_argv",
    "cleanup_argv",
]
