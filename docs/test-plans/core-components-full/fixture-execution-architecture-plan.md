...
```json
{
  "id": "tc-vmm-vmm-001",
  "execution": {
    "entrypoint": "automation/run-test.py",
    "args": [],
    "timeout_seconds": 600
  },
  "fixture": {
...
Add a profile registry under `docs/test-plans/core-components-full/fixtures/`.
Initial profiles:
...
```jsonl
{"type":"process.started","pid":1234,"entrypoint":"automation/run-test.py"}
...
- all `tools/dstack-test` tests pass;
