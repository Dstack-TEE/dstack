...
- Automation: Yes
- Requirements: [req-vmm-configurat-001](../../../feature-audit.md#req-vmm-configurat-001)
- Risks: [risk-vmm-configurat-001](../../../feature-audit.md#risk-vmm-configurat-001)
...
The `vmm` portion of [`configuration-inventory.json`](../../../configuration-inventory.json) is mandatory test data. Exercise every listed field at its implicit default, an explicit valid value, boundary-invalid values, an unknown sibling field, and after restart.
