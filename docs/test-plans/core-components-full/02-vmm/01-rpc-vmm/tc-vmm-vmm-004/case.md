...
- Automation: Yes
- Requirements: [req-vmm-vmm-004](../../../feature-audit.md#req-vmm-vmm-004)
- Risks: [risk-vmm-vmm-004](../../../feature-audit.md#risk-vmm-vmm-004)
...
- Prepared RPC contract: `Vmm.RemoveVm` takes `Id` (`id: string`) and returns `google.protobuf.Empty` (no fields). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
