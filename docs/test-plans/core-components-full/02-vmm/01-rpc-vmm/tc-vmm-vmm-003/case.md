...
- Automation: Yes
- Requirements: [req-vmm-vmm-003](../../../feature-audit.md#req-vmm-vmm-003)
- Risks: [risk-vmm-vmm-003](../../../feature-audit.md#risk-vmm-vmm-003)
...
- Prepared RPC contract: `Vmm.StopVm` takes `Id` (`id: string`) and returns `google.protobuf.Empty` (no fields). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
