...
- Automation: Yes
- Requirements: [req-vmm-vmm-013](../../../feature-audit.md#req-vmm-vmm-013)
- Risks: [risk-vmm-vmm-013](../../../feature-audit.md#risk-vmm-vmm-013)
...
- Prepared RPC contract: `Vmm.GetInfo` takes `Id` (`id: string`) and returns `GetInfoResponse` (`found: bool`, `info: VmInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
