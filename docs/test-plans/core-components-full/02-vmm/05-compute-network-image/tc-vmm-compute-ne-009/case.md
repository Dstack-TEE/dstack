...
- Automation: No
- Requirements: [req-vmm-compute-ne-009](../../../feature-audit.md#req-vmm-compute-ne-009)
- Risks: [risk-vmm-compute-ne-009](../../../feature-audit.md#risk-vmm-compute-ne-009)
...
Start the candidate netd as root on the case-owned Unix socket, allowing only
the VMM service UID. Start the candidate VMM and supervisor with isolated data,
run, PID, log, and socket paths, then query the public status endpoint.
