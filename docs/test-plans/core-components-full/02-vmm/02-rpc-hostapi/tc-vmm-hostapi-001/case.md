...
- Automation: Yes
- Requirements: [req-vmm-hostapi-001](../../../feature-audit.md#req-vmm-hostapi-001)
- Risks: [risk-vmm-hostapi-001](../../../feature-audit.md#risk-vmm-hostapi-001)
...
- Prepared RPC contract: `HostApi.Info` takes `google.protobuf.Empty` (no fields) and returns `HostInfo` (`name: string`, `version: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
