...
- Automation: Yes
- Requirements: [req-kms-onboard-004](../../../feature-audit.md#req-kms-onboard-004)
- Risks: [risk-kms-onboard-004](../../../feature-audit.md#risk-kms-onboard-004)
...
- Prepared RPC contract: `Onboard.Finish` takes `google.protobuf.Empty` (no fields) and returns `google.protobuf.Empty` (no fields). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
