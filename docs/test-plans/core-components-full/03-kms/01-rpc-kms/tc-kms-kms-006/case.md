...
- Automation: Yes
- Requirements: [req-kms-kms-006](../../../feature-audit.md#req-kms-kms-006)
- Risks: [risk-kms-kms-006](../../../feature-audit.md#risk-kms-kms-006)
...
- Prepared RPC contract: `KMS.SignCert` takes `SignCertRequest` (`api_version: uint32`, `csr: bytes`, `signature: bytes`, `vm_config: string`) and returns `SignCertResponse` (`certificate_chain: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../api-inventory.json); do not reconstruct it from implementation source.
