...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
  <Card 
    title="Deploy A DStack Application with a New guest agent" 
    icon="rocket" 
    href="/docs/getting-started/deploying-applications"
    className="hover:shadow-lg transition-shadow border-2 border-green-200"
  >
    <div className="space-y-3">
      <p className="text-sm mt-2 mb-2">
        Deploy a secure app to Dstack Framework prebuilt TDX image in minutes—no setup needed. Fastest way to deploy is to deploy to a known host with dstack installed.
      </p>
