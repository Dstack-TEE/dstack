...
use dstack_kms_rpc::{
    ...
    ActivateEpochRequest, ActivateEpochResponse, ClearImageCacheRequest, PrepareReshareRequest,
    PrepareReshareResponse, SignEpochManifestRequest, SignEpochManifestResponse,
};
