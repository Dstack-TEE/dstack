...
fn canonical_sdk_json_round_trips() {
    ...
    // three hash it to 357a3d0d...  The guest hashes the file it is given, so
    // agreement means the guest must accept exactly these bytes and re-emit
    // them unchanged.
    let canonical = r#"{"docker_compose_file":"services:\n  w:\n    image: x && y\n","kms_enabled":true,"manifest_version":"3","name":"a","requirements":{"health_check":true,"health_status_file":"/dstack/health","os_version":">=0.6.1"},"runner":"docker-compose"}"#;
