"""HTTP clients for interacting with dstack and tappd services.

This module exposes synchronous and asynchronous clients with methods for
retrieving keys, quotes, TLS materials, and service information.
"""
