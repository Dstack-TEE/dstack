...
func main() {
	...
	walletKey, err := client.GetKey(ctx, "wallet/ethereum", "mainnet")
	if err != nil {
		log.Fatal(err)
	}
...
keyResult, err := client.GetKey(ctx, "ethereum/main", "wallet")
if err != nil {
	log.Fatal(err)
}
...
keyResult, err := client.GetKey(ctx, "solana/main", "wallet")
if err != nil {
	log.Fatal(err)
}
...
wallet1, _ := client.GetKey(ctx, "app1/wallet", "ethereum")
wallet2, _ := client.GetKey(ctx, "app2/wallet", "ethereum")
// wallet1.Key != wallet2.Key (guaranteed different)

sameWallet, _ := client.GetKey(ctx, "app1/wallet", "ethereum")
...
ethWallet, _ := client.GetKey(ctx, "wallet/ethereum", "mainnet")
...
key1, _ := client.GetKey(ctx, "my-app/signing", "")
key2, _ := client.GetKey(ctx, "my-app/signing", "")
// key1.Key == key2.Key (guaranteed identical)

// Different paths return different keys
userA, _ := client.GetKey(ctx, "user/alice/wallet", "")
userB, _ := client.GetKey(ctx, "user/bob/wallet", "")  
