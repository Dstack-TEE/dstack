...
"""Client for dstack-verifier — verifies the launcher's TDX+vTPM attestation.
...
untrusted CLI cannot substitute its own key and steal the sealed CEK).
"""
...
def compute_report_data(nonce: str, transport_pub_b64: str, kms_ts: int) -> bytes:
    ...
    The launcher must compute the identical value when it calls
