...
<CardGroup cols={3}>
  <Card title="Architecture Deep Dive" icon="sitemap" href="/docs/concepts/architecture">
  ...
  <Card title="Start Building" icon="hammer" href="/docs/getting-started/first-deployment">
...
Explore the [System Architecture](/docs/concepts/architecture) to understand how dstack components work together to provide secure application deployment.

### Security

Learn about the [Security Model](/docs/concepts/security-model) including TEEs, remote attestation, and our decentralized trust architecture.

### Deployment

Ready to deploy? Check out our [First Deployment Guide](/docs/getting-started/first-deployment) for step-by-step instructions.
