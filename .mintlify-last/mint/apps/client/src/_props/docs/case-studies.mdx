...
<div className="mt-8 p-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
  ...
  <p className="text-gray-700">
    Have you successfully deployed dstack in your organization? We'd love to feature your story in our case studies. Contact us at <a href="mailto:casestudies@dstack.dev" className="text-blue-600 hover:underline">[casestudies@dstack.dev](mailto:casestudies@dstack.dev)</a> to share your experience and help others learn from your journey.
  </p>
</div>
