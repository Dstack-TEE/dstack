...
* ✅ dstack installed and running ([Installation Guide](/docs/getting-started/installation))
* ✅ TEE-capable hardware (Intel TDX)
* ✅ Docker and docker-compose installed
* ✅ Access to dstack web UI ([http://localhost:9080](http://localhost:9080))
