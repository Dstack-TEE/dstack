...
# Bearer token required by the gateway admin API
DSTACK_GATEWAY_ADMIN_TOKEN=$(tr -dc 'a-zA-Z0-9' < /dev/urandom | fold -w 48 | head -n 1)
...
DSTACK_GATEWAY_ADMIN_TOKEN=$DSTACK_GATEWAY_ADMIN_TOKEN
