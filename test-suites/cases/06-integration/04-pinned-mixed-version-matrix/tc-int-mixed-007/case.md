...
<a id="tc-int-mixed-007"></a>
# TC-INT-MIXED-007: Optional and unknown protobuf fields across pinned versions
...
- Automation: Yes
- Requirements: [req-int-mixed-007](../../../../catalog/feature-audit.md#req-int-mixed-007)
- Risks: [risk-int-mixed-007](../../../../catalog/feature-audit.md#risk-int-mixed-007)
...
Verify exact presence semantics at v0.5.4, v0.5.8, v0.5.11 and candidate service/client boundaries.
...
<a id="tc-int-mixed-007-step-01"></a>
...
<a id="tc-int-mixed-007-step-02"></a>
### Step 2: Execute the compatibility path

Replay captured requests with candidate fields omitted, unknown to old servers, explicitly empty, and populated across KMS/gateway/guest/VMM APIs.

**Expected results:**

- Old-compatible defaults preserve historical behavior, reported-empty remains distinct from not-reported where required, and unknown fields never crash or weaken authorization/port policy.

<a id="tc-int-mixed-007-step-03"></a>
...
<a id="tc-int-mixed-007-step-04"></a>
