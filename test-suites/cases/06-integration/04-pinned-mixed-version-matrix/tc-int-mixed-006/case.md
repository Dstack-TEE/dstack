...
<a id="tc-int-mixed-006"></a>
# TC-INT-MIXED-006: Rolling restart under four-version online mix
...
- Automation: Yes
- Requirements: [req-int-mixed-006](../../../../catalog/feature-audit.md#req-int-mixed-006)
- Risks: [risk-int-mixed-006](../../../../catalog/feature-audit.md#risk-int-mixed-006)
...
<a id="tc-int-mixed-006-step-01"></a>
...
<a id="tc-int-mixed-006-step-02"></a>
### Step 2: Execute the compatibility path

Maintain continuous key/cert/traffic probes while restarting one node at a time in v0.5.4→v0.5.8→v0.5.11→candidate order and reverse.
...
<a id="tc-int-mixed-006-step-04"></a>
