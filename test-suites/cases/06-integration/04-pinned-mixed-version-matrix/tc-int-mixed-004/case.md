...
<a id="tc-int-mixed-004"></a>
# TC-INT-MIXED-004: Gateway replacement matrix after KMS cutover
...
- Automation: Yes
- Requirements: [req-int-mixed-004](../../../../catalog/feature-audit.md#req-int-mixed-004)
- Risks: [risk-int-mixed-004](../../../../catalog/feature-audit.md#risk-int-mixed-004)
...
Verify each pinned old gateway can remain a traffic rollback target while candidate gateway is introduced after KMS 0.6.0 health.
...
<a id="tc-int-mixed-004-step-01"></a>
...
<a id="tc-int-mixed-004-step-02"></a>
### Step 2: Execute the compatibility path

For v0.5.4, v0.5.8 and v0.5.11 gateway sources, deploy rather than in-place mutate candidate gateway, smoke-test cert issuance and traffic, shift load, and roll back.

**Expected results:**

- Candidate and retained old gateway use the preserved KMS CA/root, serve expected guest generations, and DNS/LB cutover does not expose an untested certificate or route.

<a id="tc-int-mixed-004-step-03"></a>
...
<a id="tc-int-mixed-004-step-04"></a>
