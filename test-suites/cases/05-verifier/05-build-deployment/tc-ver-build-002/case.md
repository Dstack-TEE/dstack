...
- Automation: Yes
- Requirements: [req-ver-build-002](../../../../catalog/feature-audit.md#req-ver-build-002)
- Risks: [risk-ver-build-002](../../../../catalog/feature-audit.md#risk-ver-build-002)
...
The `verifier` portion of [`configuration-inventory.json`](../../../../catalog/configuration-inventory.json) is mandatory test data. Exercise every listed field at its implicit default, an explicit valid value, boundary-invalid values, an unknown sibling field, and after restart.
