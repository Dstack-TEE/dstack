...
- Automation: Yes
- Requirements: [req-gw-admin-004](../../../../catalog/feature-audit.md#req-gw-admin-004)
- Risks: [risk-gw-admin-004](../../../../catalog/feature-audit.md#risk-gw-admin-004)
...
- Prepared RPC contract: `Admin.RenewCert` takes `google.protobuf.Empty` (no fields) and returns `RenewCertResponse` (`renewed: bool`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
