...
- Automation: Yes
- Requirements: [req-gw-admin-019](../../../../catalog/feature-audit.md#req-gw-admin-019)
- Risks: [risk-gw-admin-019](../../../../catalog/feature-audit.md#risk-gw-admin-019)
...
- Prepared RPC contract: `Admin.GetDefaultDnsCredential` takes `google.protobuf.Empty` (no fields) and returns `GetDefaultDnsCredentialResponse` (`default_id: string`, `credential: DnsCredentialInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
