...
<a id="tc-gw-admin-010"></a>
# TC-GW-ADMIN-010: Admin.WaveKvStatus
...
- Automation: Yes
- Requirements: [req-gw-admin-010](../../../../catalog/feature-audit.md#req-gw-admin-010)
- Risks: [risk-gw-admin-010](../../../../catalog/feature-audit.md#risk-gw-admin-010)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:395`
...
- Prepared RPC contract: `Admin.WaveKvStatus` takes `google.protobuf.Empty` (no fields) and returns `WaveKvStatusResponse` (`enabled: bool`, `persistent: StoreSyncStatus`, `ephemeral: StoreSyncStatus`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Admin.WaveKvStatus`.
