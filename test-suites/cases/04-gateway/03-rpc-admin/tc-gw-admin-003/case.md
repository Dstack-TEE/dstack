...
- Automation: Yes
- Requirements: [req-gw-admin-003](../../../../catalog/feature-audit.md#req-gw-admin-003)
- Risks: [risk-gw-admin-003](../../../../catalog/feature-audit.md#risk-gw-admin-003)
...
- Prepared RPC contract: `Admin.Exit` takes `google.protobuf.Empty` (no fields) and returns `google.protobuf.Empty` (no fields). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
