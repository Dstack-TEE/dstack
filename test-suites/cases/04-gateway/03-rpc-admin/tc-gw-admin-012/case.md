...
- Automation: Yes
- Requirements: [req-gw-admin-012](../../../../catalog/feature-audit.md#req-gw-admin-012)
- Risks: [risk-gw-admin-012](../../../../catalog/feature-audit.md#risk-gw-admin-012)
...
- Prepared RPC contract: `Admin.GetGlobalConnections` takes `google.protobuf.Empty` (no fields) and returns `GlobalConnectionsStats` (`total_connections: uint64`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
