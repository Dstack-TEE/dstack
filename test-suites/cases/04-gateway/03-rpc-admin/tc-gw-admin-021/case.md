...
- Automation: Yes
- Requirements: [req-gw-admin-021](../../../../catalog/feature-audit.md#req-gw-admin-021)
- Risks: [risk-gw-admin-021](../../../../catalog/feature-audit.md#risk-gw-admin-021)
...
- Prepared RPC contract: `Admin.ListZtDomains` takes `google.protobuf.Empty` (no fields) and returns `ListZtDomainsResponse` (`domains: ZtDomainInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
