...
<a id="tc-gw-admin-001"></a>
# TC-GW-ADMIN-001: Admin.Status
...
- Automation: Yes
- Requirements: [req-gw-admin-001](../../../../catalog/feature-audit.md#req-gw-admin-001)
- Risks: [risk-gw-admin-001](../../../../catalog/feature-audit.md#risk-gw-admin-001)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:377`
...
- Prepared RPC contract: `Admin.Status` takes `google.protobuf.Empty` (no fields) and returns `StatusResponse` (`id: uint32`, `url: string`, `bootnode_url: string`, `num_connections: uint64`, `hosts: HostInfo`, `nodes: GatewayNodeInfo`, `uuid: bytes`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Admin.Status`.
