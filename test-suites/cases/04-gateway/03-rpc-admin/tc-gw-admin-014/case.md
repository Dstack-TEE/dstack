...
<a id="tc-gw-admin-014"></a>
# TC-GW-ADMIN-014: Admin.ListDnsCredentials
...
- Automation: Yes
- Requirements: [req-gw-admin-014](../../../../catalog/feature-audit.md#req-gw-admin-014)
- Risks: [risk-gw-admin-014](../../../../catalog/feature-audit.md#risk-gw-admin-014)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:405`
...
- Prepared RPC contract: `Admin.ListDnsCredentials` takes `google.protobuf.Empty` (no fields) and returns `ListDnsCredentialsResponse` (`credentials: DnsCredentialInfo`, `default_id: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Admin.ListDnsCredentials`.
