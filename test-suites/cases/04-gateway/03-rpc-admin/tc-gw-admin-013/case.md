...
- Automation: Yes
- Requirements: [req-gw-admin-013](../../../../catalog/feature-audit.md#req-gw-admin-013)
- Risks: [risk-gw-admin-013](../../../../catalog/feature-audit.md#risk-gw-admin-013)
...
- Prepared RPC contract: `Admin.GetNodeStatuses` takes `google.protobuf.Empty` (no fields) and returns `GetNodeStatusesResponse` (`statuses: NodeStatusEntry`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
