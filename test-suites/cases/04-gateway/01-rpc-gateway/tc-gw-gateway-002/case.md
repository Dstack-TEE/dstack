...
<a id="tc-gw-gateway-002"></a>
# TC-GW-GATEWAY-002: Gateway.AcmeInfo
...
- Automation: Yes
- Requirements: [req-gw-gateway-002](../../../../catalog/feature-audit.md#req-gw-gateway-002)
- Risks: [risk-gw-gateway-002](../../../../catalog/feature-audit.md#risk-gw-gateway-002)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:211`
...
- Prepared RPC contract: `Gateway.AcmeInfo` takes `google.protobuf.Empty` (no fields) and returns `AcmeInfoResponse` (`account_uri: string`, `quoted_hist_keys: QuotedPublicKey`, `account_quote: string`, `account_attestation: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Gateway.AcmeInfo`.
