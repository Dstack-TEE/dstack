...
- Automation: Yes
- Requirements: [req-gw-gateway-004](../../../../catalog/feature-audit.md#req-gw-gateway-004)
- Risks: [risk-gw-gateway-004](../../../../catalog/feature-audit.md#risk-gw-gateway-004)
...
- Prepared RPC contract: `Gateway.GetPeers` takes `google.protobuf.Empty` (no fields) and returns `GetPeersResponse` (`my_id: uint32`, `my_url: string`, `peers: PeerInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
