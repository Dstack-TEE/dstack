...
<a id="tc-gw-debug-004"></a>
# TC-GW-DEBUG-004: Debug.GetProxyState
...
- Automation: Yes
- Requirements: [req-gw-debug-004](../../../../catalog/feature-audit.md#req-gw-debug-004)
- Risks: [risk-gw-debug-004](../../../../catalog/feature-audit.md#risk-gw-debug-004)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:227`
...
- Prepared RPC contract: `Debug.GetProxyState` takes `google.protobuf.Empty` (no fields) and returns `DebugProxyStateResponse` (`instances: ProxyStateInstance`, `allocated_addresses: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Debug.GetProxyState`.
