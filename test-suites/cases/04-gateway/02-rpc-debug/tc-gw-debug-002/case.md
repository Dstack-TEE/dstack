...
<a id="tc-gw-debug-002"></a>
# TC-GW-DEBUG-002: Debug.Info
...
- Automation: Yes
- Requirements: [req-gw-debug-002](../../../../catalog/feature-audit.md#req-gw-debug-002)
- Risks: [risk-gw-debug-002](../../../../catalog/feature-audit.md#risk-gw-debug-002)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:223`
...
- Prepared RPC contract: `Debug.Info` takes `google.protobuf.Empty` (no fields) and returns `InfoResponse` (`base_domain: string`, `external_port: uint32`, `app_address_ns_prefix: string`, `version: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Debug.Info`.
