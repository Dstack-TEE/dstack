...
<a id="tc-gw-debug-003"></a>
# TC-GW-DEBUG-003: Debug.GetSyncData
...
- Automation: Yes
- Requirements: [req-gw-debug-003](../../../../catalog/feature-audit.md#req-gw-debug-003)
- Risks: [risk-gw-debug-003](../../../../catalog/feature-audit.md#risk-gw-debug-003)
- Source: `dstack/gateway/rpc/proto/gateway_rpc.proto:225`
...
- Prepared RPC contract: `Debug.GetSyncData` takes `google.protobuf.Empty` (no fields) and returns `DebugSyncDataResponse` (`my_node_id: uint64`, `peer_addrs: PeerAddrEntry`, `nodes: NodeInfoEntry`, `instances: InstanceEntry`, `persistent_keys: uint64`, `ephemeral_keys: uint64`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `Debug.GetSyncData`.
