...
- Automation: Yes
- Requirements: [req-gos-entry-001](../../../../catalog/feature-audit.md#req-gos-entry-001)
- Risks: [risk-gos-entry-001](../../../../catalog/feature-audit.md#risk-gos-entry-001)
...
The `guest-agent` portion of [`configuration-inventory.json`](../../../../catalog/configuration-inventory.json) is mandatory test data. Exercise every listed field at its implicit default, an explicit valid value, boundary-invalid values, an unknown sibling field, and after restart.
