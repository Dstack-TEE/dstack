...
<a id="tc-gos-setup-017"></a>
# TC-GOS-SETUP-017: Simulator platform selection config and mount safety
...
- Automation: Yes
- Requirements: [req-gos-setup-017](../../../../catalog/feature-audit.md#req-gos-setup-017)
- Risks: [risk-gos-setup-017](../../../../catalog/feature-audit.md#risk-gos-setup-017)
- Source: `dstack/tee-simulator/src/main.rs`
...
Verify simulator platform selection config and mount safety for documented success, boundary, failure, concurrency, and recovery behavior.
...
<a id="tc-gos-setup-017-step-01"></a>
### Step 1: Exercise the complete behavior matrix

Start every simulated TeeVariant via config and explicit CLI, missing/malformed config, mountpoint override, already-mounted path, signal and backend failure.

**Expected results:**

- Config is required and authoritative unless explicit override is allowed, correct backend mounts once, ready/unmount lifecycle is clean, and production TEE detection is not used as the enable condition.

<a id="tc-gos-setup-017-step-02"></a>
...
<a id="tc-gos-setup-017-step-03"></a>
