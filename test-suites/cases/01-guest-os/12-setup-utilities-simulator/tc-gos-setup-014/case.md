...
<a id="tc-gos-setup-014"></a>
# TC-GOS-SETUP-014: SEV-SNP simulator device ABI
...
- Automation: Yes
- Requirements: [req-gos-setup-014](../../../../catalog/feature-audit.md#req-gos-setup-014)
- Risks: [risk-gos-setup-014](../../../../catalog/feature-audit.md#risk-gos-setup-014)
- Source: `dstack/tee-simulator/src/sev_snp.rs`
...
Verify sev-snp simulator device abi for documented success, boundary, failure, concurrency, and recovery behavior.
...
<a id="tc-gos-setup-014-step-01"></a>
### Step 1: Exercise the complete behavior matrix

Exercise guest request/response, cert table, measurement, report data, malformed request, short buffers and repeated/concurrent access.

**Expected results:**

- SNP ABI structures and cert chain encode correctly, measurement binds vm_config, and malformed/undersized operations return platform-compatible errors.

<a id="tc-gos-setup-014-step-02"></a>
...
<a id="tc-gos-setup-014-step-03"></a>
