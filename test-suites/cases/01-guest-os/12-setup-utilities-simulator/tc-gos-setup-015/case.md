...
<a id="tc-gos-setup-015"></a>
# TC-GOS-SETUP-015: TPM simulator command proxy and lifecycle
...
- Automation: Yes
- Requirements: [req-gos-setup-015](../../../../catalog/feature-audit.md#req-gos-setup-015)
- Risks: [risk-gos-setup-015](../../../../catalog/feature-audit.md#risk-gos-setup-015)
- Source: `dstack/tee-simulator/src/tpm.rs`
...
Verify tpm simulator command proxy and lifecycle for documented success, boundary, failure, concurrency, and recovery behavior.
...
<a id="tc-gos-setup-015-step-03"></a>
