...
<a id="tc-gos-dstackguest-005"></a>
# TC-GOS-DSTACKGUEST-005: DstackGuest.Info
...
- Automation: Yes
- Requirements: [req-gos-dstackguest-005](../../../../catalog/feature-audit.md#req-gos-dstackguest-005)
- Risks: [risk-gos-dstackguest-005](../../../../catalog/feature-audit.md#risk-gos-dstackguest-005)
- Source: `dstack/guest-agent/rpc/proto/agent_rpc.proto:54`
...
- Prepared RPC contract: `DstackGuest.Info` takes `google.protobuf.Empty` (no fields) and returns `AppInfo` (`app_id: bytes`, `instance_id: bytes`, `app_cert: string`, `tcb_info: string`, `app_name: string`, `device_id: bytes`, `mr_aggregated: bytes`, `os_image_hash: bytes`, `key_provider_info: string`, `compose_hash: bytes`, `vm_config: string`, `cloud_vendor: string`, `cloud_product: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
...
Verify the complete request, response, authorization, state transition, and error contract of `DstackGuest.Info`.
