...
- Automation: Yes
- Requirements: [req-vmm-vmm-014](../../../../catalog/feature-audit.md#req-vmm-vmm-014)
- Risks: [risk-vmm-vmm-014](../../../../catalog/feature-audit.md#risk-vmm-vmm-014)
...
- Prepared RPC contract: `Vmm.Version` takes `google.protobuf.Empty` (no fields) and returns `VersionResponse` (`version: string`, `rev: string`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
