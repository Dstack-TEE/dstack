...
- Automation: Yes
- Requirements: [req-vmm-vmm-018](../../../../catalog/feature-audit.md#req-vmm-vmm-018)
- Risks: [risk-vmm-vmm-018](../../../../catalog/feature-audit.md#risk-vmm-vmm-018)
...
- Prepared RPC contract: `Vmm.SvList` takes `google.protobuf.Empty` (no fields) and returns `SvListResponse` (`processes: SvProcessInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
