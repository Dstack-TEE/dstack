...
- Automation: Yes
- Requirements: [req-vmm-vmm-021](../../../../catalog/feature-audit.md#req-vmm-vmm-021)
- Risks: [risk-vmm-vmm-021](../../../../catalog/feature-audit.md#risk-vmm-vmm-021)
...
- Prepared RPC contract: `Vmm.ListRegistryImages` takes `google.protobuf.Empty` (no fields) and returns `RegistryImageListResponse` (`images: RegistryImageInfo`). The authoritative field matrix is the matching entry in [`api-inventory.json`](../../../../catalog/api-inventory.json); do not reconstruct it from implementation source.
