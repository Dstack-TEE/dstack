...
- The tdxlab run must first execute `shared/automation/prepare-vmm-hugepages.sh`, which idempotently verifies hugetlbfs and provisions the bounded 2 MiB hugepage pool before fixture inventory.
