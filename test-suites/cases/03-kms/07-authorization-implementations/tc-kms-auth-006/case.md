...
<a id="tc-kms-auth-006"></a>
# TC-KMS-AUTH-006: Application boot policy image and config matrix
...
- Automation: Yes
- Requirements: [req-kms-auth-006](../../../../catalog/feature-audit.md#req-kms-auth-006)
- Risks: [risk-kms-auth-006](../../../../catalog/feature-audit.md#risk-kms-auth-006)
...
Verify application boot policy image and config matrix with explicit success, boundary, failure, restart, and isolation observations.
...
<a id="tc-kms-auth-006-step-01"></a>
...
<a id="tc-kms-auth-006-step-02"></a>
### Step 2: Exercise supported and boundary paths

Create app policies across image/config allowlists, wildcard/upgrade flags, duplicate hashes, revocation, and rollback.

**Expected results:**

- Contract and API return the same deterministic decision and unauthorized image/config/rollback cannot obtain app keys.

<a id="tc-kms-auth-006-step-03"></a>
...
<a id="tc-kms-auth-006-step-04"></a>
