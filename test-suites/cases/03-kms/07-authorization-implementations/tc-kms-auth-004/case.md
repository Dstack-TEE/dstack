...
<a id="tc-kms-auth-004"></a>
# TC-KMS-AUTH-004: KMS contract ownership roles and upgrade controls
...
- Automation: Yes
- Requirements: [req-kms-auth-004](../../../../catalog/feature-audit.md#req-kms-auth-004)
- Risks: [risk-kms-auth-004](../../../../catalog/feature-audit.md#risk-kms-auth-004)
...
Verify kms contract ownership roles and upgrade controls with explicit success, boundary, failure, restart, and isolation observations.
...
<a id="tc-kms-auth-004-step-01"></a>
...
<a id="tc-kms-auth-004-step-02"></a>
### Step 2: Exercise supported and boundary paths

Exercise owner/admin/operator actions, role transfer/revocation, pause, implementation upgrade, initialization, and unauthorized callers.

**Expected results:**

- Only assigned roles mutate policy; initialization is single-use; upgrades preserve storage and cannot bypass authorization or seize ownership.

<a id="tc-kms-auth-004-step-03"></a>
...
<a id="tc-kms-auth-004-step-04"></a>
