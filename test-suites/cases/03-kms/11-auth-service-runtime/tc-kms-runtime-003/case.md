...
<a id="tc-kms-runtime-003"></a>
# TC-KMS-RUNTIME-003: Authorization deployment and management scripts
...
- Automation: Yes
- Requirements: [req-kms-runtime-003](../../../../catalog/feature-audit.md#req-kms-runtime-003)
- Risks: [risk-kms-runtime-003](../../../../catalog/feature-audit.md#risk-kms-runtime-003)
- Source: `dstack/kms/auth-eth/script`
...
Verify authorization deployment and management scripts for documented success, boundary, failure, concurrency, and recovery behavior.
...
<a id="tc-kms-runtime-003-step-01"></a>
### Step 1: Exercise the complete behavior matrix

Run deploy/manage/query/upgrade scripts on clean and existing deployments with missing/wrong env, wrong chain, unauthorized signer and dry-run checks.

**Expected results:**

- Scripts target the recorded chain/contracts, validate signer/state/storage layout, are idempotent where documented and cannot partially mutate on preflight failure.

<a id="tc-kms-runtime-003-step-02"></a>
...
<a id="tc-kms-runtime-003-step-03"></a>
