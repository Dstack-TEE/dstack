...
<a id="tc-kms-runtime-004"></a>
# TC-KMS-RUNTIME-004: Authorization service container deployment
...
- Automation: Yes
- Requirements: [req-kms-runtime-004](../../../../catalog/feature-audit.md#req-kms-runtime-004)
- Risks: [risk-kms-runtime-004](../../../../catalog/feature-audit.md#risk-kms-runtime-004)
- Source: `dstack/kms/dstack-app`
...
Verify authorization service container deployment for documented success, boundary, failure, concurrency, and recovery behavior.
...
<a id="tc-kms-runtime-004-step-01"></a>
### Step 1: Exercise the complete behavior matrix

Deploy simple/dev/production compose and entrypoint under missing secrets, delayed chain, restart, health and upgrade.

**Expected results:**

- Only intended auth implementation starts, secrets use protected injection, health reflects dependency readiness and restart/upgrade preserves policy endpoint identity.

<a id="tc-kms-runtime-004-step-02"></a>
...
<a id="tc-kms-runtime-004-step-03"></a>
