...
- Automation: Yes
- Requirements: [req-kms-attestatio-005](../../../../catalog/feature-audit.md#req-kms-attestatio-005)
- Risks: [risk-kms-attestatio-005](../../../../catalog/feature-audit.md#risk-kms-attestatio-005)
...
The `kms` portion of [`configuration-inventory.json`](../../../../catalog/configuration-inventory.json) is mandatory test data. Exercise every listed field at its implicit default, an explicit valid value, boundary-invalid values, an unknown sibling field, and after restart.
