...
"""Record whether the complete gateway-select-007 controller is available."""
...
CAPABILITY = "gateway-select-007"
ACTION = "Top-N backend selection DNS cache and failover"
FIXTURE_KEY = "gateway_select_007"
REQUIRED = [
    "gateway_argv",
    "backend_rows",
    "dns_rows",
    ...
    "cache_warm_argv",
    "cache_expiry_argv",
    "backend_failure_argv",
    "failover_observer_argv",
