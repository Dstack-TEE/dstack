...
"""Record whether the complete gateway-registration-001 controller is available."""
...
CAPABILITY = "gateway-registration-001"
ACTION = "Attested CVM registration and re-registration"
FIXTURE_KEY = "gateway_registration_001"
REQUIRED = [
    "gateway_argv",
    "guest_rows",
    "valid_registration_argv",
    "tampered_registration_argv",
    "duplicate_key_argv",
    "duplicate_instance_argv",
    "changed_policy_argv",
    "state_observer_argv",
    "log_observer_argv",
    "cleanup_argv",
