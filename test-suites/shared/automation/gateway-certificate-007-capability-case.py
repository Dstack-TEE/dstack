...
"""Record whether the complete gateway-certificate-007 controller is available."""
...
CASE_ID = "tc-gw-certificat-007"
CAPABILITY = "gateway-certificate-007"
ACTION = "Certificate attestation history and ACME info"
FIXTURE_KEY = "gateway_certificate_007"
REQUIRED = [
    "gateway_rows",
    "certificate_rows",
    "attestation_rows",
