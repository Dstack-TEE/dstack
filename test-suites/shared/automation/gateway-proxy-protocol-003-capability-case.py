...
"""Record whether the complete gateway-proxy-protocol-003 controller is available."""
...
CAPABILITY = "gateway-proxy-protocol-003"
ACTION = "TLS passthrough SNI address resolution"
FIXTURE_KEY = "gateway_proxy_protocol_003"
REQUIRED = [
    "gateway_argv",
    "backend_rows",
    "valid_sni_rows",
