...
"""Record whether the complete gateway-cluster-admin-004 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-004"
ACTION = "Connection handshake and node statistics"
FIXTURE_KEY = "gateway_cluster_admin_004"
REQUIRED = [
    "gateway_rows",
    "peer_rows",
    "handshake_argv",
    "invalid_handshake_rows",
    "traffic_argv",
    "disconnect_argv",
    "reconnect_argv",
    "statistics_observer_argv",
