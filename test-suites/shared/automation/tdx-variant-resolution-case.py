...
"""Record whether the complete tdx-variant-resolution-matrix controller is available."""
...
CASE_ID = "tc-vmm-tdxvariant-005"
CAPABILITY = "tdx-variant-resolution-matrix"
FIXTURE_KEY = "tdx_variant_resolution"
REQUIRED = [
    "decision_rows",
    "candidate_image",
    "image_0_5_4",
    "image_0_5_8",
    "image_0_5_11",
    "kms_onboard_selector",
    "create_row_argv",
    "manifest_observer_argv",
    "qemu_observer_argv",
