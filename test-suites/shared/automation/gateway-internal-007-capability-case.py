...
"""Record whether the complete gateway-internal-007 controller is available."""
...
CAPABILITY = "gateway-internal-007"
ACTION = "Dashboard connection counters and policy provenance"
FIXTURE_KEY = "gateway_internal_007"
REQUIRED = [
    "gateway_argv",
    "backend_rows",
    "policy_rows",
