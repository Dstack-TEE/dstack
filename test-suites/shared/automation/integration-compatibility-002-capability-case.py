...
"""Record whether the complete integration-compatibility-002 controller is available."""
...
CAPABILITY = "integration-compatibility-002"
ACTION = "Rolling VMM upgrade with running mixed guests"
FIXTURE_KEY = "integration_compatibility_002"
REQUIRED = [
    "vmm_release_rows",
    "guest_release_rows",
    "host_rows",
