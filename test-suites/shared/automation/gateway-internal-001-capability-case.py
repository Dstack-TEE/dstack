...
"""Record whether the complete gateway-internal-001 controller is available."""
...
CAPABILITY = "gateway-internal-001"
ACTION = "Gateway startup certificate mode and resource limits"
FIXTURE_KEY = "gateway_internal_001"
REQUIRED = [
    "gateway_rows",
    "certificate_mode_rows",
    "resource_limit_rows",
    "startup_argv",
    "invalid_config_rows",
    "load_argv",
