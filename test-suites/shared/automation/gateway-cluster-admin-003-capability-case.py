...
"""Record whether the complete gateway-cluster-admin-003 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-003"
ACTION = "Node URL and status administration"
FIXTURE_KEY = "gateway_cluster_admin_003"
REQUIRED = [
    "gateway_rows",
    "admin_listener_argv",
    "create_argv",
