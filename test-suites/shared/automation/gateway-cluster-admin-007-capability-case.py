...
"""Record whether the complete gateway-cluster-admin-007 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-007"
ACTION = "Health dashboard and graceful exit"
FIXTURE_KEY = "gateway_cluster_admin_007"
REQUIRED = [
    "gateway_rows",
    "health_argv",
    "dashboard_argv",
    "traffic_argv",
    "shutdown_argv",
    "inflight_observer_argv",
    "exit_observer_argv",
    "counter_observer_argv",
