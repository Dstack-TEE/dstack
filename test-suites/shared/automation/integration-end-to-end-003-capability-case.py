...
"""Record whether the complete integration-end-to-end-003 controller is available."""
...
CASE_ID = "tc-int-end-to-end-003"
CAPABILITY = "integration-end-to-end-003"
ACTION = "Encrypted environment delivery"
FIXTURE_KEY = "integration_end_to_end_003"
REQUIRED = [
    "vmm_rows",
    "kms_rows",
    "guest_rows",
    ...
    "deploy_argv",
    "delivery_argv",
    "invalid_identity_argv",
    "decrypt_observer_argv",
