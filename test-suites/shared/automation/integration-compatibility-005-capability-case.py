...
"""Record whether the complete integration-compatibility-005 controller is available."""
...
CASE_ID = "tc-int-compatibil-005"
CAPABILITY = "integration-compatibility-005"
ACTION = "Verifier compatibility across evidence versions"
FIXTURE_KEY = "integration_compatibility_005"
REQUIRED = [
    "verifier_release_rows",
    "evidence_version_rows",
    "policy_rows",
    "verify_argv",
    "invalid_evidence_rows",
    "result_observer_argv",
    "compatibility_observer_argv",
    "redaction_observer_argv",
    "restart_argv",
    "cleanup_argv",
]
