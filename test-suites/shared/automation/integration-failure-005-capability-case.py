...
"""Record whether the complete integration-failure-005 controller is available."""
...
CAPABILITY = "integration-failure-005"
ACTION = "Credential and secret redaction audit"
FIXTURE_KEY = "integration_failure_005"
REQUIRED = [
    "component_rows",
    "credential_rows",
    "operation_rows",
