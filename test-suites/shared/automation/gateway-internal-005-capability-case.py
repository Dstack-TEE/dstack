...
"""Record whether the complete gateway-internal-005 controller is available."""
...
CAPABILITY = "gateway-internal-005"
ACTION = "TLS termination local routes and stream bridge"
FIXTURE_KEY = "gateway_internal_005"
REQUIRED = [
    "gateway_argv",
    "backend_argv",
    "local_route_rows",
