...
"""Record whether the complete gateway-certbot-005 controller is available."""
...
CAPABILITY = "gateway-certbot-005"
ACTION = "Certbot workdir archive live and rollback layout"
FIXTURE_KEY = "gateway_certbot_005"
REQUIRED = [
    "certbot_argv",
    "workdir_argv",
    "issue_argv",
    "renew_argv",
    "archive_observer_argv",
    "live_observer_argv",
    "rollback_argv",
    "permission_observer_argv",
    "corruption_argv",
    "cleanup_argv",
]
