...
async fn main() -> Result<()> {
    ...
    println!(
        ...
        serde_json::to_string_pretty(
            &json!({"candidate_commit":"b79ab31dd4dbf20b0991a218e5568e313307d095","source_under_test":"/home/kvin/src/dstack.worktrees/candidate-b79ab31/dstack/gateway/src/main_service/auth_client.rs","first_allow_before_restart":first,"adjacent_identity_authorized":adjacent,"allow_after_client_restart":after_restart,"auth_request_identity_order":seen,"passed":passed})
        )?
    );
    if !passed {
        std::process::exit(1);
