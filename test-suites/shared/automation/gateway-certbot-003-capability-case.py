...
"""Record whether the complete gateway-certbot-003 controller is available."""
...
CAPABILITY = "gateway-certbot-003"
ACTION = "Cloudflare DNS record API boundaries"
FIXTURE_KEY = "gateway_certbot_003"
REQUIRED = [
    "certbot_argv",
    "cloudflare_endpoint_argv",
    "credential_rows",
    "record_rows",
    "create_argv",
    "update_argv",
