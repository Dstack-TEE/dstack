...
"""Record whether the complete gateway-cluster-admin-001 controller is available."""
...
CAPABILITY = "gateway-cluster-admin-001"
ACTION = "WaveKV bootstrap replication and convergence"
FIXTURE_KEY = "gateway_cluster_admin_001"
REQUIRED = [
    "gateway_rows",
    "wavekv_rows",
    "bootstrap_argv",
