...
CASE_ID = "tc-vmm-internal-004"
CAPABILITY = "vmm-mr-config-snp-hostdata-matrix"
FIXTURE_KEY = "vmm_mr_config"
REQUIRED = [
    "input_rows",
    "compute_argv",
    "kms_reference_argv",
    "verifier_reference_argv",
    "mutation_rows",
    "digest_observer_argv",
    "snp_hostdata_observer_argv",
    "concurrency_argv",
    "failure_inject_argv",
    "cleanup_argv",
]
