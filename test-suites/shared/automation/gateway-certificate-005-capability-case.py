...
"""Record whether the complete gateway-certificate-005 controller is available."""
...
CASE_ID = "tc-gw-certificat-005"
CAPABILITY = "gateway-certificate-005"
ACTION = "CAA publication and validation"
FIXTURE_KEY = "gateway_certificate_005"
REQUIRED = [
    "gateway_argv",
    "provider_rows",
    "domain_rows",
