...
"""Record whether the complete gateway-certbot-002 controller is available."""
...
CASE_ID = "tc-gw-certbot-002"
CAPABILITY = "gateway-certbot-002"
ACTION = "DNS-01 authorization propagation and cleanup"
FIXTURE_KEY = "gateway_certbot_002"
REQUIRED = [
    "certbot_argv",
    "dns_provider_argv",
    "domain_rows",
    ...
    "cleanup_argv",
    "dns_observer_argv",
    "artifact_observer_argv",
    "post_cleanup_observer_argv",
]
