...
"""Record whether the complete gateway-registration-002 controller is available."""
...
CAPABILITY = "gateway-registration-002"
ACTION = "WireGuard IP allocation and peer lifecycle"
FIXTURE_KEY = "gateway_registration_002"
REQUIRED = [
    "gateway_argv",
    "guest_rows",
    "registration_argv",
