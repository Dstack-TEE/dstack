...
"""Record whether the complete gateway-certbot-001 controller is available."""
...
CASE_ID = "tc-gw-certbot-001"
CAPABILITY = "gateway-certbot-001"
ACTION = "ACME account creation load and credential persistence"
FIXTURE_KEY = "gateway_certbot_001"
REQUIRED = [
    "certbot_argv",
    "acme_directory_argv",
    "credential_rows",
