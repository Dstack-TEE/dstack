...
"""Record whether the complete integration-failure-007 controller is available."""
...
CASE_ID = "tc-int-failure-se-007"
CAPABILITY = "integration-failure-007"
ACTION = "Network partition consistency matrix"
FIXTURE_KEY = "integration_failure_007"
REQUIRED = [
    "component_rows",
    "topology_rows",
    "partition_rows",
    ...
    "partition_argv",
    "heal_argv",
    "consistency_observer_argv",
    "availability_observer_argv",
    "convergence_observer_argv",
    "cleanup_argv",
]
