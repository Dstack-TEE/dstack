...
"""Record whether the complete gateway-certbot-004 controller is available."""
...
CASE_ID = "tc-gw-certbot-004"
CAPABILITY = "gateway-certbot-004"
ACTION = "Certificate renewal threshold force and hook"
FIXTURE_KEY = "gateway_certbot_004"
REQUIRED = [
    "certbot_argv",
    "certificate_rows",
    "threshold_rows",
